...
1. Download the [current release](https://github.com/nvrnight/chessbuddies/releases/tag/1.0.7) from the [Releases tab](https://github.com/nvrnight/chessbuddies/releases)
